...
export type SeedProductArray = SeedProduct[];
export type SeedUserArray = SeedUser[];

interface SeedData {
  products: SeedProductArray;
  users: SeedUserArray;
}

const products: SeedProductArray = [
  {
    description:
...
const users: SeedUserArray = [
  {
    email: 'test@gmail.com',
    password: 'Lamaravilla22233',
    fullName: 'J Oyola baby la maravilla',
    isActive: true,
    roles: ['admin', 'user'],
  },
];
